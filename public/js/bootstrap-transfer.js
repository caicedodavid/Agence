                ...
                <tr>\
                    <td width="50%">\
                        <div class="selector-available">\
                            ...
                            <button href="#" class="btn btn-primary selector-chooseall btn-sm">Choose all</button>\
                        </div>\
                    </td>\
                    <td>\
                        <div class="selector-chooser" style="margin-right:4px">\
                    ...
                    <td width="50%">\
                        <div class="selector-chosen">\
                            ...
                            <button href="#" class="btn btn-primary selector-clearall btn-sm">Clear all</button>\
                        </div>\
                    </td>\
                </tr>\
            </table>',
